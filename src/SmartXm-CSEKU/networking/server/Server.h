...
public:
  ...
  // Public accessor that returns a thread-safe snapshot copy of current
  // clients. This allows other modules (e.g. TeacherModule) to query current
  // clients.
...
protected:
  Server(int port = 8080, const std::string &secret =
                              "MySuperSecret123x"); // constructor protected e
  ~Server();
