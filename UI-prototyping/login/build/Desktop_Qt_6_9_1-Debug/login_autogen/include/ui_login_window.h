...
public:
    ...
    void setupUi(QMainWindow *Login_Window)
    {
        ...
        widget->setGeometry(QRect(110, 30, 611, 491));
        ...
        SmartXm_logo = new QLabel(widget);
        ...
        SmartXm_label = new QLabel(widget);
        ...
        emailTextField = new QLineEdit(widget);
        ...
        passTextField = new QLineEdit(widget);
