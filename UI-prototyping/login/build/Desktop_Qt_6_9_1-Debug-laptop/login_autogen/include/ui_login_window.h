...
public:
    ...
    void setupUi(QMainWindow *Login_Window)
    {
        ...
        Login_Window->resize(806, 674);
        QIcon icon;
        icon.addFile(QString::fromUtf8("SmartXm-logo-mini.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        tabWidget->setGeometry(QRect(10, 30, 771, 591));
        tab = new QWidget();
        tab->setObjectName("tab");
        layoutWidget = new QWidget(tab);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(70, 40, 611, 491));
        ...
        SmartXm_logo->setPixmap(QPixmap(QString::fromUtf8("SmartXm-logo-mid.png")));
    ...
    void retranslateUi(QMainWindow *Login_Window)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("Login_Window", "Tab 1", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("Login_Window", "Tab 2", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("Login_Window", "Page", nullptr));
