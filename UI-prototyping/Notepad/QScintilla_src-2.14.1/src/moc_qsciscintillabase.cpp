...
template <> constexpr inline auto QsciScintillaBase::qt_create_metaobjectdata<qt_meta_tag_ZN17QsciScintillaBaseE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const char *, int, int, int, int)>(49, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 }, { QMetaType::Int, 14 }, { QMetaType::Int, 10 }, { QMetaType::Int, 11 },
            { QMetaType::Int, 9 },
        }}),
        // Signal 'SCN_USERLISTSELECTION'
        QtMocHelpers::SignalData<void(const char *, int, int, int)>(49, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 7, 8 }, { QMetaType::Int, 14 }, { QMetaType::Int, 10 }, { QMetaType::Int, 11 },
        }}),
        // Signal 'SCN_USERLISTSELECTION'
        QtMocHelpers::SignalData<void(const char *, int)>(49, 2, QMC::AccessPublic, QMetaType::Void, {{
