...
template <> constexpr inline auto QsciLexer::qt_create_metaobjectdata<qt_meta_tag_ZN9QsciLexerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const QColor &, int)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 3 }, { QMetaType::Int, 4 },
        }}),
        ...
        // Signal 'fontChanged'
        QtMocHelpers::SignalData<void(const QFont &, int)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QFont, 8 }, { QMetaType::Int, 4 },
        }}),
        // Signal 'paperChanged'
        ...
        QtMocHelpers::SignalData<void(const char *, const char *)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
        ...
        // Slot 'setColor'
        QtMocHelpers::SlotData<void(const QColor &, int)>(16, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 3 }, { QMetaType::Int, 4 },
        }}),
        // Slot 'setColor'
        QtMocHelpers::SlotData<void(const QColor &)>(16, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::QColor, 3 },
        }}),
        // Slot 'setEolFill'
        QtMocHelpers::SlotData<void(bool, int)>(17, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 18 }, { QMetaType::Int, 4 },
        }}),
        // Slot 'setEolFill'
        ...
        // Slot 'setFont'
        QtMocHelpers::SlotData<void(const QFont &, int)>(19, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QFont, 8 }, { QMetaType::Int, 4 },
        }}),
        // Slot 'setFont'
        QtMocHelpers::SlotData<void(const QFont &)>(19, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::QFont, 8 },
        }}),
        // Slot 'setPaper'
        QtMocHelpers::SlotData<void(const QColor &, int)>(20, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 3 }, { QMetaType::Int, 4 },
        }}),
        // Slot 'setPaper'
        QtMocHelpers::SlotData<void(const QColor &)>(20, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { QMetaType::QColor, 3 },
        }}),
    };
