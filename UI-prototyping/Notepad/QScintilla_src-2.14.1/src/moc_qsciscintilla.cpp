...
template <> constexpr inline auto QsciScintilla::qt_create_metaobjectdata<qt_meta_tag_ZN13QsciScintillaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(AutoCompletionSource)>(56, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 57, 58 },
        }}),
        ...
        QtMocHelpers::SlotData<void(AutoCompletionUseSingle)>(61, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 62, 55 },
        }}),
        // Slot 'setAutoIndent'
        ...
        QtMocHelpers::SlotData<void(BraceMatch)>(65, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 66, 67 },
        }}),
        ...
        QtMocHelpers::SlotData<void(const QColor &)>(72, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 71 },
        }}),
        ...
        // Slot 'setColor'
        QtMocHelpers::SlotData<void(const QColor &)>(78, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 79 },
        }}),
        // Slot 'setCursorPosition'
        QtMocHelpers::SlotData<void(int, int)>(80, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::Int, 4 },
        }}),
        // Slot 'setEolMode'
        QtMocHelpers::SlotData<void(EolMode)>(81, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 82, 83 },
        }}),
        // Slot 'setEolVisibility'
        QtMocHelpers::SlotData<void(bool)>(84, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 85 },
        }}),
        // Slot 'setFolding'
        QtMocHelpers::SlotData<void(FoldStyle, int)>(86, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 87, 88 }, { QMetaType::Int, 13 },
        }}),
        // Slot 'setFolding'
        QtMocHelpers::SlotData<void(FoldStyle)>(86, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { 0x80000000 | 87, 88 },
        }}),
        // Slot 'setIndentation'
        QtMocHelpers::SlotData<void(int, int)>(89, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 3 }, { QMetaType::Int, 90 },
        }}),
        ...
        QtMocHelpers::SlotData<void(const QColor &)>(92, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 71 },
        }}),
        ...
        // Slot 'setLexer'
        QtMocHelpers::SlotData<void(QsciLexer *)>(97, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 98, 99 },
        }}),
        // Slot 'setLexer'
        QtMocHelpers::SlotData<void()>(97, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void),
        // Slot 'setMarginsBackgroundColor'
        QtMocHelpers::SlotData<void(const QColor &)>(100, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 71 },
        }}),
        // Slot 'setMarginsFont'
        QtMocHelpers::SlotData<void(const QFont &)>(101, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QFont, 102 },
        }}),
        // Slot 'setMarginsForegroundColor'
        QtMocHelpers::SlotData<void(const QColor &)>(103, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 71 },
        }}),
        // Slot 'setMarginLineNumbers'
        QtMocHelpers::SlotData<void(int, bool)>(104, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 13 }, { QMetaType::Bool, 105 },
        }}),
        // Slot 'setMarginMarkerMask'
        QtMocHelpers::SlotData<void(int, int)>(106, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 13 }, { QMetaType::Int, 107 },
        }}),
        // Slot 'setMarginSensitivity'
        QtMocHelpers::SlotData<void(int, bool)>(108, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 13 }, { QMetaType::Bool, 109 },
        }}),
        // Slot 'setMarginWidth'
        QtMocHelpers::SlotData<void(int, int)>(110, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 13 }, { QMetaType::Int, 74 },
        }}),
        // Slot 'setMarginWidth'
        QtMocHelpers::SlotData<void(int, const QString &)>(110, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 13 }, { QMetaType::QString, 111 },
        }}),
        // Slot 'setModified'
        ...
        // Slot 'setPaper'
        QtMocHelpers::SlotData<void(const QColor &)>(113, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 79 },
        }}),
        // Slot 'setReadOnly'
        ...
        // Slot 'setSelection'
        QtMocHelpers::SlotData<void(int, int, int, int)>(116, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 117 }, { QMetaType::Int, 118 }, { QMetaType::Int, 119 }, { QMetaType::Int, 120 },
        }}),
        // Slot 'setSelectionBackgroundColor'
        QtMocHelpers::SlotData<void(const QColor &)>(121, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 71 },
        }}),
        // Slot 'setSelectionForegroundColor'
        QtMocHelpers::SlotData<void(const QColor &)>(122, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QColor, 71 },
        }}),
        // Slot 'setTabIndents'
        QtMocHelpers::SlotData<void(bool)>(123, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 37 },
        }}),
        // Slot 'setTabWidth'
        QtMocHelpers::SlotData<void(int)>(124, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 74 },
        }}),
        // Slot 'setText'
        QtMocHelpers::SlotData<void(const QString &)>(125, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 24 },
        }}),
        // Slot 'setUtf8'
        ...
        QtMocHelpers::SlotData<void(WhitespaceVisibility)>(128, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 129, 83 },
        }}),
        // Slot 'setWrapMode'
        QtMocHelpers::SlotData<void(WrapMode)>(130, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 131, 83 },
        }}),
        // Slot 'undo'
        ...
        // Slot 'zoomIn'
        QtMocHelpers::SlotData<void(int)>(133, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 134 },
        }}),
        // Slot 'zoomIn'
        ...
        // Slot 'zoomTo'
        QtMocHelpers::SlotData<void(int)>(136, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 137 },
        }}),
        // Slot 'handleCallTipClick'
        QtMocHelpers::SlotData<void(int)>(138, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 139 },
        }}),
        ...
        QtMocHelpers::SlotData<void(int, int)>(142, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 143 }, { QMetaType::Int, 144 },
        }}),
        // Slot 'handleIndicatorRelease'
        QtMocHelpers::SlotData<void(int, int)>(145, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 143 }, { QMetaType::Int, 144 },
        }}),
        // Slot 'handleMarginClick'
        QtMocHelpers::SlotData<void(int, int, int)>(146, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 143 }, { QMetaType::Int, 13 }, { QMetaType::Int, 144 },
        }}),
        // Slot 'handleMarginRightClick'
        QtMocHelpers::SlotData<void(int, int, int)>(147, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 143 }, { QMetaType::Int, 13 }, { QMetaType::Int, 144 },
        }}),
        // Slot 'handleModified'
        QtMocHelpers::SlotData<void(int, int, const char *, int, int, int, int, int, int, int)>(148, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 143 }, { QMetaType::Int, 149 }, { 0x80000000 | 150, 24 }, { QMetaType::Int, 151 },
            { QMetaType::Int, 152 }, { QMetaType::Int, 3 }, { QMetaType::Int, 153 }, { QMetaType::Int, 154 },
            { QMetaType::Int, 155 }, { QMetaType::Int, 156 },
        }}),
        // Slot 'handlePropertyChange'
        QtMocHelpers::SlotData<void(const char *, const char *)>(157, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 150, 158 }, { 0x80000000 | 150, 159 },
        }}),
        ...
        QtMocHelpers::SlotData<void(const char *, int)>(164, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 150, 24 }, { QMetaType::Int, 21 },
        }}),
        // Slot 'handleStyleColorChange'
        QtMocHelpers::SlotData<void(const QColor &, int)>(165, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QColor, 79 }, { QMetaType::Int, 166 },
        }}),
        // Slot 'handleStyleEolFillChange'
        QtMocHelpers::SlotData<void(bool, int)>(167, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Bool, 168 }, { QMetaType::Int, 166 },
        }}),
        // Slot 'handleStyleFontChange'
        QtMocHelpers::SlotData<void(const QFont &, int)>(169, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QFont, 102 }, { QMetaType::Int, 166 },
        }}),
        // Slot 'handleStylePaperChange'
        QtMocHelpers::SlotData<void(const QColor &, int)>(170, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QColor, 79 }, { QMetaType::Int, 166 },
        }}),
        // Slot 'handleUpdateUI'
        QtMocHelpers::SlotData<void(int)>(171, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 172 },
        }}),
