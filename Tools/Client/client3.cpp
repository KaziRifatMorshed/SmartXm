...
void receive_file(int client_sock_fd) {
    while (true) {
        ...
        std::string path = "/home/seam/Desktop/SmartXm/UI-prototyping/Notepad/";
        std::string filename = path + "received_file";
        ...
        TarHandler::extractTar(path, filename);

        system("xmessage 'Problem is ready to be loaded!'");
